  ...
  return (
    <div className="App">
      <header className="App-header">
        ...
        <p>Green Stocks is still being built.</p>
        <p>If you don't already have a Robinhood account, use 
          <a href="https://join.robinhood.com/edwind329"> my referral link </a>
          to get a free stock.
        </p>
        ...
        <p>TSLA - Tesla, Inc. engages in the design, development, manufacture, and sale of fully electric vehicles, energy generation and storage systems. 
          Feel free to use <a href="https://www.tesla.com/referral/edwin1642?fbclid=IwAR3jREMZZO3LAr1TNs36zFeB_vygP9qFLjAILeEA2uXxqwwnfCMxVQXxbyM" target="_blank">
